...
namespace RedBubble.Application.Services
{
    public class DesignService : IDesignService
    {
        ...
        public async Task CreateAsync(ArtistDesignDTO artistDesignDTO , string artistId)
        {
        ...
        public async Task<IEnumerable<ArtistGetDesignDTO>> GetAllAsync(string artistId)
        {
