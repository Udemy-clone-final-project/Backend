...
namespace RedBubble.Dashboard.Extensions
{
    public static class DashboardServicesExtensions
    {
        public static IServiceCollection AddDashboardServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            // AppDbContext is already registered in AddPersistenceServices
            ...
            services.AddScoped<RedBubble.Dashboard.Services.IEmailSender, RedBubble.Dashboard.Services.EmailSender>();
            ...
            // IUnitOfWork is already registered in AddPersistenceServices
